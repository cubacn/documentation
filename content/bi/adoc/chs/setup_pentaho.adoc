...
+
--
* 下载 https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.6.0/cuba-bi-pentaho-1.6.0.jar[cuba-bi-pentaho-1.6.0.jar] 然后拷贝到 `$PENTAHO_HOME$/pentaho-server/tomcat/webapps/pentaho/WEB-INF/lib`。

* 下载 https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.6.0/cuba-bi-pentaho-1.6.0-plugin.zip[cuba-bi-pentaho-1.6.0-plugin.zip]，解压后拷贝 `saiku-cuba-bi` 目录到 `$PENTAHO_HOME/pentaho-server/pentaho-solutions/system`。

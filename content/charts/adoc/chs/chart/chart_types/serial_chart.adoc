...
<div class="manual-live-demo-container">
    <a href="https://demo.cuba-platform.cn/sampler/open?screen=line-chart" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="https://demo.cuba-platform.cn/sampler/open?screen=columnline-chart" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++

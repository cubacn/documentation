...
`ConfigStorageMBean` 能在 http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/core/jmx/ConfigStorageMBean.html[中间件] 、 http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/web/jmx/ConfigStorageMBean.html[Web 客户端] 和 http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/portal/jmx/ConfigStorageMBean.html[Web 门户] 模块中查看和设置<<app_properties,应用程序属性>>的值。

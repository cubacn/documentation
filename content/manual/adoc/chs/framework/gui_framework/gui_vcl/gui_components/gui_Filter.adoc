...
<div class="manual-live-demo-container">
    <a href="https://demo.cuba-platform.com/sampler/open?screen=multiple-filter" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++
...
注意不能在界面的 <<abstractFrame,init()>> 方法中使用这些方法，因为过滤器在那时还没有初始化。比较合适的使用过滤器参数的地方是 <<abstractWindow,ready()>> 方法。

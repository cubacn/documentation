...
<1> – 参考 https://demo.cuba-platform.com/sampler/open?screen=datagrid-detailsgenerator[DataGridDetailsGeneratorSample] 类中的 `createCloseButton` 方法描述。
<2> – 参考 https://demo.cuba-platform.com/sampler/open?screen=datagrid-detailsgenerator[DataGridDetailsGeneratorSample] 类中的 `getContent` 方法描述。

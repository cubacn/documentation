...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/DataGrid.html" class="api-docs-btn" target="_blank">API 文档</a>
</div>
++++
...
<1> – 参考 https://demo.cuba-platform.com/sampler/open?screen=datagrid-detailsgenerator[DataGridDetailsGeneratorSample] 类中的 `createCloseButton` 方法全部代码。
<2> – 参考 https://demo.cuba-platform.com/sampler/open?screen=datagrid-detailsgenerator[DataGridDetailsGeneratorSample] 类中的 `getContent` 方法全部代码。

...
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/BulkEditor.html" class="api-docs-btn" target="_blank">API 文档</a>
</div>
++++
...
[WARNING]
====
`BulkEditor` 只能用在使用了<<gui_legacy,遗留 API>>的界面中。最新 API 的类似功能通过<<gui_BulkEditAction,BulkEditAction>>提供。
====

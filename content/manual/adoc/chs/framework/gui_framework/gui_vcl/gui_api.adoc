...
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/Component.html" class="api-docs-btn" target="_blank">API 文档</a>
</div>
++++
...
这两个方法支持所有可视化组件。
--
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/Buffered.html[Buffered-缓冲写入模式接口] ::
+
--
[[gui_api_commit]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/Collapsable.html[Collapsable-可折叠接口] ::
+
--
[[gui_api_expanded]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/ComponentContainer.html[ComponentContainer-组件容器接口] ::
+
--
[[gui_api_add]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/OrderedContainer.html[OrderedContainer-有序容器接口] ::
+
--
[[gui_api_indexOf]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasContextHelp.html[HasContextHelp-内容提示接口] ::
+
--
[[gui_api_contextHelp]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasSettings.html[HasSettings-用户设置接口] ::
+
--
[[gui_api_settings]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasUserOriginated.html[HasUserOriginated-事件来源接口] ::
+
--
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasValue.html[HasValue-有值处理接口] ::
+
--
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/LayoutClickNotifier.html[LayoutClickNotifier-布局点击通知接口] ::
+
--
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasMargin.html[HasMargin-容器边距接口] ::
+
--
[[gui_api_margin]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasOuterMargin.html[HasOuterMargin-组件外边距接口] ::
+
--
[[gui_api_outerMargin]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/HasSpacing.html[HasSpacing-留白接口] ::
+
--
[[gui_api_spacing]]
...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/gui/components/ShortcutNotifier.html[ShortcutNotifier-快捷键接口] ::
+
--
[[gui_api_shortcut]]
